...
$GLOBALS['TCA']['tx_agora_domain_model_group'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_agora_domain_model_group']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_agora_domain_model_group.pid=###CURRENT_PID### AND tx_agora_domain_model_group.sys_language_uid IN (-1,0)',
			),
		),
