...
$GLOBALS['TCA']['tx_agora_domain_model_thread'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, solved, closed, sticky, creator, posts, views, groups_with_read_access, group_with_write_access, groups_with_modification_access, users_with_read_access, users_with_write_access, users_with_modification_access',
	),
	'types' => array(
	...
	'columns' => array(
		...
		'group_with_write_access' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:agora/Resources/Private/Language/locallang_db.xlf:tx_agora_domain_model_thread.group_with_write_access',
			'config' => array(
				'type' => 'select',
				'foreign_table' => 'fe_groups',
				'MM' => 'tx_agora_thread_groupwithwriteaccess_group_mm',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
		...
		'users_with_write_access' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:agora/Resources/Private/Language/locallang_db.xlf:tx_agora_domain_model_thread.users_with_write_access',
			'config' => array(
				'type' => 'select',
				'foreign_table' => 'fe_users',
				'MM' => 'tx_agora_thread_userswithwriteaccess_user_mm',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
