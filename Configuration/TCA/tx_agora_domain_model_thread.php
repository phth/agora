...
return [
    'ctrl' => array(
        'title' => $lll . 'tx_agora_domain_model_thread',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'iconfile' => 'typo3conf/ext/agora/Resources/Public/Icons/tx_agora_domain_model_thread.gif'
    ),
    'interface' => array(
    ...
    'columns' => array(
        ...
        'l10n_parent' => array(
            ...
            'config' => array(
                ...
                'foreign_table_where' => 'AND tx_agora_domain_model_thread.pid=###CURRENT_PID### AND
                                                tx_agora_domain_model_thread.sys_language_uid IN (-1,0)',
            ),
        ),
        ...
        'crdate' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.crdate',
            'config' => array(
                'type' => 'none',
                'format' => 'date',
                'eval' => 'date'
        ...
        'tstamp' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.tstamp',
            'config' => array(
                'type' => 'none',
                'format' => 'date',
                'eval' => 'date'
        ...
        'title' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.title',
            'config' => array(
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
        ...
        'solved' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.solved',
            'config' => array(
                'type' => 'check',
                'default' => 0
            )
        ...
        'closed' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.closed',
            'config' => array(
                'type' => 'check',
                'default' => 0
            )
        ...
        'sticky' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.sticky',
            'config' => array(
                'type' => 'check',
                'default' => 0
            )
        ...
        'creator' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.creator',
            'config' => array(
                'type' => 'select',
                'renderType' => 'selectSingleBox',
                'items' => array(
        ...
        'posts' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.posts',
            'config' => array(
                'type' => 'inline',
        ...
        'views' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.views',
            'config' => array(
                'type' => 'inline',
        ...
        'forum' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.forum',
            'config' => array(
                'type' => 'select',
                'renderType' => 'selectSingleBox',
                'items' => array(
        ...
        'observers' => array(
            'exclude' => 1,
            'label' => $lll . 'tx_agora_domain_model_thread.observers',
            'config' => array(
                'type' => 'select',
                'renderType' => 'selectSingleBox',
                'foreign_table' => 'fe_users',
