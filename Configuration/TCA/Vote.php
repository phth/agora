...
$GLOBALS['TCA']['tx_agora_domain_model_vote'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_agora_domain_model_vote']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_agora_domain_model_vote',
				'foreign_table_where' => 'AND tx_agora_domain_model_vote.pid=###CURRENT_PID### AND tx_agora_domain_model_vote.sys_language_uid IN (-1,0)',
			),
		),
		...
		'voting' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:agora/Resources/Private/Language/locallang_db.xlf:tx_agora_domain_model_vote.voting',
			'config' => array(
				'type' => 'inline',
		...
		'voting_answers' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:agora/Resources/Private/Language/locallang_db.xlf:tx_agora_domain_model_vote.voting_answers',
			'config' => array(
				'type' => 'inline',
