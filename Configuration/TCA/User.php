...
$GLOBALS['TCA']['tx_agora_domain_model_user'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_agora_domain_model_user']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, signiture, posts, favorite_threads, observed_threads, spam_posts',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, signiture, posts, favorite_threads, observed_threads, spam_posts, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_agora_domain_model_user.pid=###CURRENT_PID### AND tx_agora_domain_model_user.sys_language_uid IN (-1,0)',
			),
		),
		...
		'favorite_threads' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:agora/Resources/Private/Language/locallang_db.xlf:tx_agora_domain_model_user.favorite_threads',
			'config' => array(
				'type' => 'inline',
