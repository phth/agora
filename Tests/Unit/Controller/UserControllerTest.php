...
class UserControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \AgoraTeam\Agora\Controller\UserController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('AgoraTeam\\Agora\\Controller\\UserController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
